...
function clickHandler(event) {
    //вам нужно очищать содержимое .products
        productsEl.innerHTML = "";  //Взято из предыдущих заданий
    //в showCategory надо передать строку с типом категории, тип берите
    //из атрибута data-type у кнопки, по которой кликнули.
    showCategory(event.target.dataset.type); //Взято из предыдущих заданий
}
 ...
 * в верху этого файла.
 */
function getProductMarkup(product) {  //Использовал шаблон из своего старого задания
    return `
            <div class="product">
