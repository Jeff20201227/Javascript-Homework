...
const openBasketBtn = document.querySelector('section.header_cart');
const basketEl = document.querySelector('.cart_fon');
const basketCounterEl = document.querySelector('.header_cart span');
